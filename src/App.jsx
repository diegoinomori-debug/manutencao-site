        ...
        {page === "factory" && (
          ...
          <div className="tableWrap">
            ...
            <div className="reportGrid">
              ...
              <label>
                ⑤停止除外時間
                <input placeholder="例: 00:30" />
              </label>

              <label>
                ⑥機能低下(%)
                <input type="number" placeholder="例: 100" />
              </label>
            ...
            <div className="reportGrid">
              ...
              <label>
                作業者
                <input type="number" placeholder="名" />
              </label>

              <label>
                保全工数
                <input value="0.00 H" readOnly />
              </label>

              <label>
                労務費
                <input value="0 円" readOnly />
              </label>
            </div>
        ...
        {page === "dashboard" && (
          <div className="tableWrap">
            ...
            <div className="cards">
              ...
              <div className="card">
                <span>工場記録数</span>
                <strong>{factoryLogs.length}</strong>
              </div>
            </div>
          </div>
        )}
